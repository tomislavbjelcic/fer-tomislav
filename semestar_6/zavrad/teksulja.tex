...
Uz grupiranje, izračunate su mjere unutarnjeg i vanjskog vrednovanja za svako grupiranje i prikazane su tablicom %TODO: NAPRAVI TABLICU%.
...
\kljucnerijeci{Grupiranje, nenadzirano strojno učenje, mjera udaljenosti, Euklidova udaljenost, K-sredina, centroid, K-means++, metoda koljena, miješana gustoća, GMM, MLE, EM algoritam, AIC, hijerarhijsko aglomerativno grupiranje, kriterij spajanja, Ward, model gustoće točaka, DBSCAN, šum, Davies-Bouldin indeks, vrijednost siluete, Randov indeks, uzajamna informacija, Scikit-Learn, Python}
\end{sazetak}
%‘‘slični’’
