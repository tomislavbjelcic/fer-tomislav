...
\end{equation}
Uveli smo oznaku $\pi_k = P \left(y = k\right)$, i tu vjerojatnost nazivamo \textbf{koeficijent mješavine} \engl{mixture weight}. U slučaju modela Gaussove mješavine, gustoća grupe $p \left(\mathbf{x} \middle| \boldsymbol{\theta}_k\right)$ se računa prema \ref{gaussdensity}, gdje su parametri grupe
