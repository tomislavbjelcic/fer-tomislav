...
from grader_lab2 import grade_solution, parse_output, log_results
...
def iterate_student_solutions(evaluation_log_file=None, solutions_dir=None, 
                              test_suites_dir=None, test_directory=None, for_jmbag=None, student_log_dir=None):
    ...
    for test_instance in test_suite[subtask]:
      ...
      if result_code == ERR_EXECUTE:
        ...
        if not report['test_passed']:
          report['expected_output'] = test_instance['expected_output_full']
...
def parse_arguments():
  ...
  parser.add_argument('--test_suites', type=str, default='test_suites_lab2',
                        help='Directory containing test suites to run')
  parser.add_argument('--evaluation_log', type=str, default='full.log',
                        help='Path to file with evaluation log output')
  parser.add_argument('--lab_files', type=str, default='lab2_files',
                        help='Path to folder with lab files')
