...
class FC(Layer):
    def __init__(self, input_layer, num_outputs, name,
        ...
        # potrebno pamtiti kako bismo mogli računati gradijente
        self.inputs = None
...
class ReLU(Layer):
    def __init__(self, input_layer, name):
        ...
        # opet je potrebno pamtiti zadnji input
        self.inputs = None
...
class SoftmaxCrossEntropyWithLogits():
    ...
    def forward(self, x, y):
        ...
        """
        # TODO
        log_probs = y * log_softmax(x, axis=1)
    ...
    def backward_inputs(self, x, y):
        ...
        # TODO
        return (softmax(x, axis=1) - y) / x.shape[0]
...
class L2Regularizer():
    ...
    def forward(self):
        ...
        """
        # TODO
        return 0.5 * self.weight_decay * np.sum(self.weights * self.weights)
